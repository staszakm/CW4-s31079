...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select( e => new{e.EName,Total = e.Sal + (e.Comm!=0? e.Comm : 0) }); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts,e=>e.DeptNo,d=>d.DeptNo,(e,d)=>new{e.EName,e.Sal,d.DName}).SelectMany(ed=>grades.Where(g=> ed.Sal > g.Losal && ed.Sal < g.Hisal),(ed,g)=>new{ed.EName,ed.DName,g.Grade}).ToList(); 
